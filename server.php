...
//DBMS connection code->hostname, username, password, databasename
...
if(isset($_POST['reg_user']))
{
    ...
    //Data sanitization is done to prevent SQL injection
    $username = mysqli_real_escape_string($db, $_POST['username']);
    $email = mysqli_real_escape_string($db, $_POST['email']);
    $password_1 = mysqli_real_escape_string($db, $_POST['password_1']);
    $password_2 = mysqli_real_escape_string($db, $_POST['password_2']);
    
    //Ensuring that the user has not left any input field blank error messages will be displayed
    //for every blank input 
...
if(isset($_POST['login_user']))
{
    ...
    //Error message if the input field is left blanck
    if(empty($username)){
