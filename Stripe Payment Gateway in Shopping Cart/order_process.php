...
<html>
 ...
 <body>
  <div class="container">
   <br />
   <h3 align="center"><a href="#" style="font-family: 'Zen Tokyo Zoo', cursive;">TASTY TREATS</a></h3>
   <br />
   <span id="message"></span>
   <div class="panel panel-default">
    <div class="panel-heading" style="font-family: 'Zen Tokyo Zoo', cursive;">Order Process</div>
    <div class="panel-body">
     <form method="post" id="order_process_form" action="payment.php">
      <div class="row">
       <div class="col-md-8" style="border-right:1px solid #ddd;">
        <h4 align="center" style="font-family: 'Zen Tokyo Zoo', cursive;">Customer Details</h4>
        <div class="form-group">
         <label><b>Card Holder Name <span class="text-danger">*</span></b></label>
           ...
           <hr />
           <h4 align="center" style="font-family: 'Zen Tokyo Zoo', cursive;">Payment Details</h4>
           <div class="form-group">
       ...
       <div class="col-md-4">
        <h4 align="center" style="font-family: 'Zen Tokyo Zoo', cursive;">Order Details</h4>
        <?php
        echo $order_details;
        ?>
       </div>
...
//Check video PART-7 for Stripe Payment Integration
